      ...
      <Container className="flex flex-wrap ">
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-8">
            ...
            <p
              className="py-5 text-xl leading-normal text-gray-700 lg:text-xl xl:text-3xl dark:text-gray-300"
              // style={{ maxWidth: "580px" }}
            >
              We are a research department expertise in
              <br></br>Data Engineer, System Development and
              <br></br>High performance service.
            </p>
            <p className=" pb-6  leading-normal text-gray-600 lg:text-xl xl:text-xl dark:text-gray-300">
